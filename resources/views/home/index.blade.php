        ...
        <div class=" max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
            <div class="relative">
                <h2 class="text-center text-4xl leading-8 font-extrabold tracking-tight text-indigo-600 sm:text-6xl">
                    Encuentra el trabajo de limpieza de forma remota</h2>
                <p class="mt-4 max-w-3xl mx-auto text-center text-xl text-gray-500">Encuentra los mejores servicios de
                    limpieza!</p>
            </div>
        </div>
    </div>
